...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
    ...
    $businessName = filter_var($_POST['business_name'], FILTER_SANITIZE_STRING);
    $businessAddress = filter_var($_POST['business_address'], FILTER_SANITIZE_STRING);
    ...
    $stmt = $conn->prepare("UPDATE landlords SET company_name = ?, company_address = ? WHERE user_id = ?");
    $stmt->bind_param("ssi", $businessName, $businessAddress, $userId);
    $stmt->execute();
...
$stmt = $conn->prepare("
    SELECT u.first_name, u.last_name, u.email, u.phone, u.profile_image, 
           l.company_name, l.company_address
    FROM users u
  ...
  <nav class="navbar">
    <div class="nav-container">
      ...
      <div class="nav-center">
        ...
        <a href="../guest/properties.html" class="nav-link">Properties</a>
    ...
    <div class="nav-menu-mobile" id="nav-menu-mobile">
      ...
      <a href="../guest/properties.html" class="nav-link-mobile">Properties</a>
        ...
        <div class="main-area">
          ...
          <div class="profile-content">
            ...
            <form class="profile-form" method="POST" action="profile.php">
              ...
              <div class="form-group">
                <label for="business_name">Business/Agency Name</label>
                <input type="text" id="business_name" name="business_name" value="<?php echo htmlspecialchars($user['company_name']); ?>">
              </div>
              
              <div class="form-group">
                <label for="business_address">Business Address</label>
                <input type="text" id="business_address" name="business_address" value="<?php echo htmlspecialchars($user['company_address']); ?>">
              </div>
