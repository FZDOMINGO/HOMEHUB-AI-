...
<body>
  ...
  <main class="main-content">
    <div class="container">
      ...
      <!-- Template for activities (hidden) -->
      <div style="display: none;">
        <!-- Success Activity Template -->
        <div class="activity-item success" data-category="reservations" data-date="2025-09-22" id="activity-template">
