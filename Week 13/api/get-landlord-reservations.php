...
error_log("=== LANDLORD RESERVATIONS API CALLED ===");
...
if (!isset($_SESSION['user_id']) || $_SESSION['user_type'] !== 'landlord') {
    error_log("Access denied - not logged in as landlord");
...
try {
    ...
    error_log("Landlord ID found: " . $landlordId);
    ...
    error_log("Total reservations found: " . count($reservations));
