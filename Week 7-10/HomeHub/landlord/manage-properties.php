...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_property'])) {
    ...
    // First delete related records (property images, etc.)
...
<head>
  ...
  <title>Manage Properties - HomeHub AI</title>
  <link rel="stylesheet" href="dashboard.css">
  <link rel="stylesheet" href="manage-properties.css">
...
<div class="property-actions">
  ...
  <form method="POST" action="manage-properties.php" class="delete-form">
    <input type="hidden" name="property_id" value="<?php echo $property['id']; ?>">
    <button type="submit" name="delete_property" class="btn-delete" 
