document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadReservationRequests() {
        ...
        console.log('Loading reservation requests...');
        ...
        fetch('api/get-landlord-reservations.php')
                    ...
                    if (data.reservations && data.reservations.length > 0) {
                        ...
                        container.innerHTML = `
                            <div class="no-bookings">
                                <p>You don't have any reservation requests.</p>
                                <p style="margin-top: 10px;">Reservation requests will appear here when tenants submit booking forms for your properties.</p>
                            </div>
                        `;
                    }
                } else {
            ...
            .catch(error => {
                ...
                container.innerHTML = '<div class="error-message">❌ Failed to load reservation requests. Please check console for details.</div>';
            });
    }
                    ...
                    <div class="visit-card-body">
                        <div class="visit-tenant-info">
                            ...
                            <div class="tenant-details">
                                ...
                                <div class="tenant-contact">
                                    <i class="fas fa-phone"></i> ${visit.tenant_phone || visit.phone_number || 'No phone number'}
                                </div>
                            </div>
                        </div>
