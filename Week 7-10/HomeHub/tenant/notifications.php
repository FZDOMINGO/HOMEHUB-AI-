    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-logo">
                ...
                <span class="logo-text">HomeHub AI</span>
            </div>
            ...
            <!-- Notification Icon (Added for all pages) -->
        ...
        <div class="nav-menu-mobile" id="nav-menu-mobile">
            ...
            <a href="notifications.php" class="nav-link-mobile">Notifications</a>
        </div>
    </nav>
            ...
            <div class="dashboard-layout">
                ...
                <div class="main-area">
                    <div class="notifications-header">
                        <h1>Notifications</h1>
                        <p>Stay updated on your booking requests, property viewings, and landlord responses</p>
                    </div>
            ...
            button.addEventListener('click', function() {
                ...
                switch (type) {
                    ...
                    case 'booking_update':
                        ...
                        break;
                    case 'property_alert':
                        window.location.href = '../properties.php?id=' + id;
                        break;
                    case 'message':
...
function getActionButton($type, $id) {
    switch ($type) {
        case 'visit_update':
            return '<button class="notification-action-btn" data-type="visit_update" data-id="'.$id.'">View Details</button>';
        case 'booking_update':
            return '<button class="notification-action-btn" data-type="booking_update" data-id="'.$id.'">Check Status</button>';
        case 'property_alert':
            return '<button class="notification-action-btn" data-type="property_alert" data-id="'.$id.'">View Property</button>';
        case 'message':
