            ...
            <div class="property-details-container">
                ...
                <div class="property-actions">
                    <?php if ($isLoggedIn && $userType == 'tenant'): ?>
                        ...
                        <button type="button" id="scheduleVisitBtn" class="btn-action btn-secondary" data-property-id="<?php echo $propertyId; ?>">
                            <i class="fas fa-calendar-check"></i>
                            Schedule Visit
                        </button>
                        <form method="POST" action="property-detail.php?id=<?php echo $propertyId; ?>" style="display: inline;">
                    ...
                    <?php elseif (!$isLoggedIn): ?>
                        ...
                        <a href="login/login.html" class="btn-action btn-secondary">
                            <i class="fas fa-calendar-check"></i>
...
<div class="booking-form" id="booking-form">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Reserve Property and Schedule Visit functionality
        ...
        if (scheduleVisitBtn) {
            scheduleVisitBtn.addEventListener('click', function() {
                ...
                document.getElementById('visit_property_id').value = propertyId;
        ...
        if (visitForm) {
            visitForm.addEventListener('submit', function(e) {
                ...
                .then(data => {
                    if (data.success) {
                        alert('Visit request submitted successfully! The landlord will review your request.');
                        this.reset();
    ...
    <div id="visitModal" class="modal">
        <div class="modal-content">
            ...
            <form id="visitForm" method="POST">
                <input type="hidden" id="visit_property_id" name="property_id" value="<?php echo $propertyId; ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="visit_message" name="message" rows="3" placeholder="Any questions or special requests..."></textarea>
                </div>
